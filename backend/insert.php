<?php
    ...
    if(isset($_POST)){
        ...
        if ($mode == "true") {
            ...
            $template = $conn->prepare("INSERT INTO Pazienti(Cod_fiscale, Nome, Cognome, Data_Nascita, Sesso, Email, Password) VALUES (:cod_fiscale, :nome, :cognome, :data_nascita, :sesso, :email, :password)");
